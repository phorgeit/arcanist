 ...
 */
final class ArcanistAliasFunctionPHPASTLinterRule
  extends ArcanistPHPASTNodeLinterRule {

  const ID = 65;

  private $functionAliases = array(
    '_' => 'gettext',
    'chop' => 'rtrim',
    'close' => 'closedir',
    'com_get' => 'com_propget',
  ...
  public function process(PhpParser\Node $node, array $token_stream) {
    if (
      ...
      if (isset($this->functionAliases[$function_name])) {
        $this->raiseLintAtNode(
          $node->name,
          pht('Alias functions should be avoided.'),
          $this->functionAliases[$function_name],
          $token_stream);
      }
    } else if (
      $node instanceof PhpParser\Node\Expr\Exit_ &&
      $node->getAttribute('kind') === PhpParser\Node\Expr\Exit_::KIND_DIE) {
