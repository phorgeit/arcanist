...
/**
 * You can extend this class and set `phpast.naminghook` in your `.arclint` to
 ...
 */
abstract class ArcanistPHPASTLintNamingHook extends Phobject {


/* -(  Internals  )---------------------------------------------------------- */

  /**
   * The constructor is final because @{class:ArcanistPHPASTLinter} is
...
/* -(  Overriding Symbol Name Lint Messages  )------------------------------- */
   ...
   * symbol types are: class, interface, trait, enum, function, method,
   * parameter, constant, and member.
   *
